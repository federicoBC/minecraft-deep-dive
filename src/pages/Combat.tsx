...
const CombatPage = () => {
  const items = getByCategory('combat');
  const subcategories = getSubcategories('combat');
  ...
  return (
    <SectionLayout
      title="Combattimento"
      description="Meccaniche di combattimento PvP e PvE, distanze di rilevamento mob, strategie boss e molto altro."
