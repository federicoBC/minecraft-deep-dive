...
const FarmPage = () => {
  const items = getByCategory('farm');
  const subcategories = getSubcategories('farm');
  ...
  return (
    <SectionLayout
      title="Farm"
      description="Guide complete per costruire farm automatiche efficienti. Dai creeper al ferro, dall'XP all'oro."
